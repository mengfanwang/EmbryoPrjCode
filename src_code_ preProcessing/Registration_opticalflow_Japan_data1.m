...
if isunix
    ...
    fore_folder = '/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_detection_removal/Wei_refine_res';
    save_folder = '/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_detection_removal/Registration';
end
...
if reg_ind == 5
    fore2_backup(117:127,870:880,1:5) = 0;
elseif reg_ind == 23
    fore2_backup(80:95,500:515,20:24) = 0;
elseif reg_ind == 26
    fore2_backup(652:662,868:878,25:29) = 0;
elseif reg_ind == 27
    fore2_backup(851:863,995:1006,42:45) = 0;
elseif reg_ind == 31
    fore2_backup(586:596,210:220,20:24) = 0;
elseif reg_ind == 45
    fore2_backup(807:817,724:734,1:3) = 0;
elseif reg_ind == 47
    fore2_backup(150:165,318:327,36:40) = 0;
elseif reg_ind == 49
    fore2_backup(1:10,410:425,1:8) = 0;
elseif reg_ind == 68
    fore2_backup(720:730,630:640,38:42) = 0;
    fore2_backup(430:440,635:645,43:44) = 0;
elseif reg_ind == 77
    fore2_backup(225:240,325:340,15:19) = 0;
elseif reg_ind == 78
    fore2_backup(900:910,985:1000,22:26) = 0;
elseif reg_ind == 83
    fore2_backup(120:130,500:515,1:4) = 0;
elseif reg_ind == 101
    fore2_backup(462:473,150:160,3:6) = 0;
elseif reg_ind == 106
    fore2_backup(26:36,92:103,1:4) = 0;
elseif reg_ind == 139
    fore2_backup(86:96,438:448,3:7) = 0;
end
