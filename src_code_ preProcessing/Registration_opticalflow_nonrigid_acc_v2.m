...
elseif reg_ind == 50
    fore2_backup(640:650,200:220,5:10) = 0;
elseif ismember(reg_ind, [54 58 77 85 87 90 91])
    fore2_backup(890:910,575:600,1:5) = 0;
elseif reg_ind == 126
    fore2_backup(360:370,945:955,57:62) = 0;
elseif reg_ind == 161
    fore2_backup(730:740,815:825,175:179) = 0;
elseif reg_ind == 180
    fore2_backup(635:645,635:645,57:61) = 0;
end
%%             size          block
