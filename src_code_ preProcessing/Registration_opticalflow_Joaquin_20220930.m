...
%     fore_folder = '/work/public/sameViewFusion/sameViewDetection_10/Wei_refine_res';
    ...
    fore_folder = '/work/Mengfan/Embryo/20220930_Joaquin/Detection_view9/Wei_refine_res';
end
...
elseif reg_ind == 6
    fore2_backup(470:485,900:920,142:147) = 0;
elseif reg_ind == 7
    fore2_backup(45:55,655:670,233:238) = 0;
    fore2_backup(380:390, 950:960, 68:73) = 0;
elseif reg_ind == 23
    fore2_backup(370:380, 920:930, 95:100) = 0;
elseif reg_ind == 74
    fore2_backup(245:255, 930:940, 240:244) = 0;
elseif reg_ind == 81
    fore2_backup(481:540, 901:960, 5:11) = 0;
elseif reg_ind == 83
    fore2_backup(661:720, 661:720, 1:3) = 0;
    fore2_backup(721:750, 631:660, 1:3) = 0;
elseif reg_ind == 84
    fore2_backup(661:720, 661:720, 1:18) = 0;
    fore2_backup(721:780, 541:630, 1:5) = 0;
elseif reg_ind == 88
    fore2_backup(601:630, 31:60, 136:144) = 0;
elseif reg_ind == 90
    fore2_backup(481:540, 122:180, 200:216) = 0;
elseif reg_ind == 99
    fore2_backup(301:330, 691:750, 1:3) = 0;
elseif reg_ind == 126
    fore2_backup(241:270, 661:690, 1:9) = 0;
    fore2_backup(481:540, 601:660, 1:3) = 0;
elseif reg_ind == 145
    fore2_backup(691:720, 241:270, 1:9) = 0;
elseif reg_ind == 166
    fore2_backup(90:100, 10:20, 56:60) = 0;
elseif reg_ind == 177
    fore2_backup(490:500, 85:95, 256:261) = 0;
elseif reg_ind == 181
    fore2_backup(105:115, 625:635, 256:261) = 0;
elseif reg_ind == 183
    fore2_backup(305:315, 950:end, 127:131) = 0;
elseif reg_ind == 216
    fore2_backup(480:490, 85:95, 259:261) = 0;
elseif reg_ind == 222
    fore2_backup(890:900, 680:690, 248:252) = 0;
elseif reg_ind == 237
    fore2_backup(500:510, 920:940, 7:12) = 0;
    fore2_backup(260:280, 675:690, 257:260) = 0;
end
%%             size          block
...
save(['/work/Mengfan/Embryo/20220930_Joaquin/Registration/' data1_name '.mat'],'phi_current_vec', 'loss', 'mse_ori' ,'-v7.3');
end
